...
public class MonoVO {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < imageList.length - 1; i++) {
            ...
            DoubleIndexer ri = RwMat.createIndexer();
            DoubleIndexer ti = TwMat.createIndexer();
            System.out.printf("[%f, %f, %f,\n%f, %f, %f\n%f, %f, %f]\n[%f, %f, %f]\n",
                    ri.get(0, 0), ri.get(0, 1), ri.get(0, 2),
                    ri.get(1, 0), ri.get(1, 1), ri.get(1, 2),
                    ri.get(2, 0), ri.get(2, 1), ri.get(2, 2),
                    ti.get(0, 0), ti.get(1, 0), ti.get(2, 0));
